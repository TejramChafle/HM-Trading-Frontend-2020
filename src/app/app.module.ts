...
import { DrawLuckyCustomersPrintComponent } from './components/draw-lucky-customers-print/draw-lucky-customers-print.component';
...
@NgModule({
    declarations: [
        ...
        DrawLuckyCustomersPrintComponent
    ],
    imports: [
        BrowserModule,
        AppRoutingModule,
